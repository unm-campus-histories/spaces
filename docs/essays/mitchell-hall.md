...
{% include figure.html class="img-right" width="45%" caption="Mitchell Hall in 1951" src="images/mitchell-hall-bw-outside.jpg" %}
...
{% include figure.html class="img-middle" width="50%" caption="Construction" src="images/mitchell-hall-bw-construction.jpg" %}
...
{% include figure.html class="img-middle" width="75%" caption="Basement floor plans" src="images/mitchell-hall-basement.jpg" %}
{% include figure.html class="img-middle" width="75%" capttion="1st and 2nd floor plans" src="images/mitchell-hall-floor-plans-one.jpg" %}
### No  Refrigeration
