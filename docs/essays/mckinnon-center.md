...
{% include figure.html class="img-left" width="25%" caption="The McKinnon Center for Management" src="images/mcm.jpg" %} {% include figure.html class="img-center" width="25%" caption="The McKinnon Center for Management" src="images/mcm.jpg" %} {% include figure.html class="img-right" width="25%" caption="The McKinnon Center for Management" src="images/mcm.jpg" %}
