...
{% include figure.html class="img-left" width="33%" caption="Demolition of the ASM building" src="images/mcm-construction-1.jpg" %} {% include figure.html class="img-right" width="33%" caption="Removal of interior materials to be separated and recycled" src="images/mcm-construction-4.jpg" %}
{% include figure.html class="img-center" width="33%" caption="Early morning construction while campus is empty" src="images/mcm-construction-2.jpg" %}
