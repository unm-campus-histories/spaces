...
{% include figure.html class="img-right" width="60%" caption="View looking northeast photo by L. Johnson" src="images/cj-side.jpg" %}
...
{% include figure.html class="img-left" width="60%" caption="Front of the C & J Building today looking toward the main entrance from Redondo Drive." src="images/cj-today.jpg" %}
