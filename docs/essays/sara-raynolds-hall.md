...
{% include figure.html class="img-right" width="25%" caption="A small, simple floor plan with ambitious intentions" src="images/srh-floor_plan.jpg" %}
...
{% include figure.html class="img-left" width="25%" caption="Contractor EJ Marchant's winning bid for construction: a whopping $15,720" src="images/srh-ej_merchant_letter.jpg" %}
