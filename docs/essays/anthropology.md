...
## Construction
{% include figure.html class="img-right" width="50%" caption="Albuquerque Progress reports on the 'Students Union' opening, 1937." src="images\anth-student-union-opening.jpg" %}
...
{% include figure.html class="img-left" width="47%" caption="Even after completion, the SUB stood amongst barren terrain." src="images\anth-exterior.jpg" %}
