...
## Construction
{% include figure.html class="img-left" width="50%" caption="Looking east on the construction of the original Student Union Building, 1936." src="images\anth-construction.jpg" %}

{% include figure.html class="img-right" width="50%" caption="The completed SUB still stood among rather barren terrain." src="images\anth-exterior.jpg" %}
